---- ZeroFront GCW Map Randomizer Script by Phobos
...
-- GLOBAL
SetTeamName(ALL, "Alliance") -- Zombies
SetTeamName(IMP, "Empire") -- Humans
...
ReadDataFile("sound\\bes.lvl;bes2gcw"); -- ReadDataFile("sound\\tat.lvl;tat1gcw"); -- tusken sounds 
...
ReadDataFile("SIDE\\dewpod.lvl","all_fly_falcon","all_hover_barge","all_hover_hovernaut","all_hover_podracer","all_hover_swampspeeder","dewback");
ReadDataFile("SIDE\\myn.lvl",
        "myn_inf_basic");

SetTeamName(ALL, "Alliance")
	AddUnitClass(ALL, "all_inf_soldierurban",10)
    AddUnitClass(ALL, "all_inf_vanguard",10)
    AddUnitClass(ALL, "all_inf_pilot",10)
    AddUnitClass(ALL, "all_inf_marksman",10)
	AddUnitClass(ALL, "bothan_inf_spy",10)
    SetHeroClass(ALL, "geo_inf_yoda")
	SetUnitCount(ATT, 50)
	SetReinforcementCount(ATT, 500)

SetTeamName(IMP, "Empire")
	AddUnitClass(IMP, "imp_inf_storm_trooper",10)
    AddUnitClass(IMP, "imp_inf_shock_trooper",10)
    AddUnitClass(IMP, "imp_inf_pilottie",10)
    AddUnitClass(IMP, "imp_inf_scout_trooper",10)
    AddUnitClass(IMP, "imp_inf_dark_trooper",10)
	SetHeroClass(IMP, "myn_inf_darthjarjar")
	SetUnitCount(DEF, 50)
